        ...
        public int Registrar(Producto obj, out string Mensaje)
        {
            ...
            try
            {
                using (cn = new SqlConnection(Conexion.connectionString))
                {
                    ...
                    SqlCommand cmd = new SqlCommand("sp_RegistrarProducto".ToString(), cn);
        ...
        public bool Editar(Producto obj, out string Mensaje)
        {
            ...
            try
            {
                using (cn = new SqlConnection(Conexion.connectionString))
                {
                    ...
                    SqlCommand cmd = new SqlCommand("sp_ModificarProducto".ToString(), cn);
        ...
        public bool Eliminar(Producto obj, out string Mensaje)
        {
            ...
            try
            {
                using (cn = new SqlConnection(Conexion.connectionString))
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SP_EliminarProducto".ToString(), cn);
                    cmd.Parameters.AddWithValue("IdProducto", obj.IdProducto);
