...
namespace CapaPresentacion
{
    public partial class frmProveedores : Form
    {
        ...
        private void frmProveedores_Load(object sender, EventArgs e)
        {
            ...
            {
                dgv_Data.Rows.Add(new object[] {"",item.IdProveedor,item.Documento,item.RazonSocial,item.Correo,item.Telefono,
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            if (obj.IdProveedor == 0)
            {
                ...
                if (idgenerado != 0)
                {
                    dgv_Data.Rows.Add(new object[] {"",idgenerado,txt_documento.Text,txt_razonsocial.Text,txt_correo.Text,txt_telefono.Text,
        ...
        private void dgv_Data_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            ...
            //    e.Graphics.DrawImage(Properties.Resources.Check, new Rectangle(x, y, w, y));
            //    e.Handled = true;
            //}
        }
        ...
        private void dgv_Data_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgv_Data.Columns[e.ColumnIndex].Name == "btnseleccionar")
            {
                ...
                if (indice >= 0)
                {
                    ...
                    txt_razonsocial.Text = dgv_Data.Rows[indice].Cells["RazonSocial"].Value.ToString();
